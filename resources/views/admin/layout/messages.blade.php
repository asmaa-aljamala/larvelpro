...
@endif
@if($errors->any())
    <div class="alert alert-success alert-dismissible" style="background-color: #c40512;color: #ffffff ; padding: 15px ;border-radius: 20px">
        <h5 style="color: #ffffff"> Errors</h5>
